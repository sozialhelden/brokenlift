# RailsAdmin config file. Generated on December 03, 2011 14:37
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Brokenlifts', 'Admin']
  ...
  # config.excluded_models = [Event, Lift, Line, Network, Operator, Station]

  # Add models here if you want to go 'whitelist mode':
  # config.included_models = [Event, Lift, Line, Network, Operator, Station]
  ...
  #   # Found associations:
  #     configure :network, :belongs_to_association 
  #     configure :stations, :has_many_association   #   # Found columns:
  #     configure :id, :integer 
  #     configure :name, :string 
  #     configure :network_id, :integer         # Hidden 
  #     configure :created_at, :datetime 
  #     configure :updated_at, :datetime   #   # Sections:
  #   list do; end
  #   export do; end
  ...
  #     configure :lines, :has_many_association   #   # Found columns:
  #     configure :id, :integer 
  #     configure :name, :string 
  ...
  #   # Found associations:
  #     configure :line, :belongs_to_association 
  #     configure :lifts, :has_many_association   #   # Found columns:
  #     configure :id, :integer 
  #     configure :name, :string 
  #     configure :line_id, :integer         # Hidden 
  #     configure :created_at, :datetime 
  #     configure :updated_at, :datetime   #   # Sections:
  #   list do; end
  #   export do; end
